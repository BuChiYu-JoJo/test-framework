...
class Locator(Base):
    ...
    primary_type = Column(String(20), default="")
    strategies_json = Column(Text, default="")
    ai_confidence = Column(String(10), default="")  # AI 生成置信度，如 "0.95"
    version = Column(String(20), default="1.0.0")
    updated_by = Column(String(100), default="")
    health_color = Column(String(8), default="grey")   # green/yellow/red/grey
    last_healed_at = Column(DateTime, nullable=True)   # 最近一次 AI 自愈时间
