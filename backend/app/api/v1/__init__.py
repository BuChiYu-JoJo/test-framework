...
from app.api.v1 import ai_locators, ai_cases, ai_regression, performance, seo, proxy, crawler, explore
from app.api.v1 import tasks, locator_repair
...
# 新增：统一任务调度 + Locator 修复审计
router.include_router(tasks.router)
router.include_router(locator_repair.router)