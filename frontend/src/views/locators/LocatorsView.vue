        ...
        <div class="element-list">
          ...
          <div v-if="currentPage && elements.length" class="element-table-wrap">
            <el-table :data="elements" stripe size="small">
              <el-table-column prop="element_key" label="Key" width="200">
                  ...
                  <div style="display:flex;align-items:center;gap:6px">
                    <span
                      :style="{
                        ...
                        borderRadius: '50%',
                        flexShrink: 0,
                        background: { green: '#67C23A', yellow: '#E6A23C', red: '#F56C6C', grey: '#C0C4CC' }[row.health_color] || '#C0C4CC',
                      }"
                      :title="{ green: '健康', yellow: '注意', red: '告警', grey: '无数据' }[row.health_color] || '无数据'"
                    />
